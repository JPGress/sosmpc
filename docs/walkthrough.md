...
- **Safe Media (Zona Suja)**: Criou-se o `plugins/diversos/mpc_iso_validator.py`, que faz cálculo iterativo progressivo de `sha256sum` em Python limitando chance de ISO corrompida.
